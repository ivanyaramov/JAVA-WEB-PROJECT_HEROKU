...
public class HotelServiceImpl implements HotelService {
    ...
    public void initialiseHotels() {
       ...
       Hotel balkan = new Hotel("Hotel Balkan", 5, BigDecimal.valueOf(150), BigDecimal.valueOf(100), townService.findByName("Sofia"),"https://res.cloudinary.com/ivoto22/image/upload/v1635951571/luxury-hotel-infinity-pool-palms-600w-648165631_yiwwea.webp");
            ...
            Hotel radisson = new Hotel("Radisson", 4, BigDecimal.valueOf(270), BigDecimal.valueOf(248), townService.findByName("Lyon"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025716/istockphoto-151567458-612x612_lvtbnc.jpg");
            Hotel princessa = new Hotel("Hotel Spa Princessa", 4, BigDecimal.valueOf(270), BigDecimal.valueOf(248), townService.findByName("Andorra la Vella"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025734/istockphoto-453010649-612x612_nh5cfg.jpg");
            Hotel vitium = new Hotel("Vitium", 4, BigDecimal.valueOf(220), BigDecimal.valueOf(210), townService.findByName("Madrid"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025819/photo-1527853787696-f7be74f2e39a_cdqbxk.jpg");
            Hotel artisticbed = new Hotel("Artistic Bed", 4, BigDecimal.valueOf(221), BigDecimal.valueOf(208), townService.findByName("Madrid"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025889/istockphoto-1165384568-612x612_ljkfvm.jpg");
            Hotel stcrhistopher = new Hotel("St Crhistopher", 4, BigDecimal.valueOf(245), BigDecimal.valueOf(213), townService.findByName("Barcelona"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025908/istockphoto-104731717-612x612_fuenmq.jpg");
            Hotel colonial = new Hotel("Colonial", 3, BigDecimal.valueOf(150), BigDecimal.valueOf(124), townService.findByName("Barcelona"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025927/istockphoto-827319750-612x612_deiw4q.jpg");
            Hotel ramblas = new Hotel("Ramblas", 5, BigDecimal.valueOf(350), BigDecimal.valueOf(342), townService.findByName("Barcelona"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025948/istockphoto-636484522-612x612_cl3jmq.jpg");
            Hotel hiltonseville = new Hotel("Hilton Seville", 4, BigDecimal.valueOf(298), BigDecimal.valueOf(275), townService.findByName("Seville"),"https://res.cloudinary.com/ivoto22/image/upload/v1636025984/istockphoto-1157525825-612x612_kraui1.jpg");
            Hotel zurincharm = new Hotel("Zurin Charm", 4, BigDecimal.valueOf(180), BigDecimal.valueOf(174), townService.findByName("Lisbon"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026014/istockphoto-642901636-612x612_r0di75.jpg");
            Hotel exeessenzia = new Hotel("Exe Essenzia", 4, BigDecimal.valueOf(197), BigDecimal.valueOf(182), townService.findByName("Porto"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026033/istockphoto-1170143183-612x612_eumjj5.jpg");
            Hotel dreamgrand = new Hotel("Dream Grand", 3, BigDecimal.valueOf(89), BigDecimal.valueOf(74), townService.findByName("Male"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026072/istockphoto-1002337806-612x612_zh9nlr.jpg");
            Hotel samangrand = new Hotel("Seaman grand", 4, BigDecimal.valueOf(120), BigDecimal.valueOf(111), townService.findByName("Male"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026090/istockphoto-144723536-612x612_s5fes5.jpg");
            Hotel goldentulip = new Hotel("Golden Tulip", 4, BigDecimal.valueOf(88), BigDecimal.valueOf(68), townService.findByName("Istanbul"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026110/istockphoto-172201725-612x612_nbquyq.jpg");
            Hotel radissonistanbul = new Hotel("Radisson Istanbul", 5, BigDecimal.valueOf(141), BigDecimal.valueOf(128), townService.findByName("Istanbul"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026139/istockphoto-183018477-612x612_uaagsk.jpg");
            Hotel hiltonistanbul = new Hotel("Hilton Istanbul", 5, BigDecimal.valueOf(155), BigDecimal.valueOf(132), townService.findByName("Istanbul"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026166/istockphoto-519218778-612x612_stq2xp.jpg");
            Hotel towerhotel = new Hotel("The tower hotel", 5, BigDecimal.valueOf(250), BigDecimal.valueOf(231), townService.findByName("London"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026197/istockphoto-1196188482-612x612_yuhk6k.jpg");
            Hotel centralparkhotel = new Hotel("Central Park hotel", 3, BigDecimal.valueOf(120), BigDecimal.valueOf(100), townService.findByName("London"),"https://res.cloudinary.com/ivoto22/image/upload/v1636026220/istockphoto-1161036959-612x612_f2tivz.jpg");
